package com.example.javabase.design_patterns.my.some.action.strategy.util;

/**
 * @program: java-base
 * @description:
 * @author: soulx
 * @create: 2019-09-27 10:02
 **/
...
public class ClassScaner{
    ...
    public static void main(String[] args) {
        Set<Class<?>> scan = ClassScaner.scan("com.example.javabase.design_patterns.my.some.action.strategy.model");
        for (Class<?> c:scan) {
